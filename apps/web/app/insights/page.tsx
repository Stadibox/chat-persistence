      ...
      <div className="grid place-items-center px-8 py-20">
        <div className="card max-w-md p-8 text-center fade-up">
          ...
          <p className="mt-2 text-sm text-(--color-fg-muted)">
            El Cartógrafo correrá un cron diario que genera <code>AGENTS_INDEX.md</code>,
            detecta áreas sin cobertura, cuellos de botella y propone nuevos agentes citando
            flow_id concreto del corpus Stadibox.
          </p>
          <p className="mt-3 text-[11px] text-(--color-fg-dim)">
            Se prende en F5 · ULTRAPLAN §3.1
          </p>
        </div>
      </div>
    </>
